...
import com.zettamine.mpa.scm.dto.ErrorResponseDto;
...
//	}
	 ...
	 * handleCustomerAlreadyExistsException(Exception ex, WebRequest webRequest) {
	 * ErrorResponseDto error = new ErrorResponseDto();
	 * 
	 * error.setApiPath(webRequest.getDescription(false));
	 * error.setErrorCode(HttpStatus.BAD_REQUEST);
...
//	}
	 ...
	 * ResponseEntity<ErrorResponseDto>
	 * handleNullPointerExceptionException(Exception ex, WebRequest webRequest) {
	 * ErrorResponseDto error = new ErrorResponseDto();
	 * 
	 * error.setApiPath(webRequest.getDescription(false));
	 * error.setErrorCode(HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<ErrorResponseDto> handleSurveyorAlreadyExistsException(DuplicationException exception, WebRequest webRequest) {
